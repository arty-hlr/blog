...
![SharpHound.exe run successfully]({{site.url}}/assets/images/running_exe.png)
...
![SharpHound.ps1 run successfully]({{site.url}}/assets/images/running_powershell.png)

My quest was complete!

# Conclusion

I did manage to bypass Defender, and I learned a lot of things about antivirus software in the process, but I didn't dive very deep into bypassing AMSI and the reflection mechanism in C#, which could be the topics of future blog posts.
